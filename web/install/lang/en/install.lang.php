...
define("LANG_STEP0_INTROTEXT", "You're about to install this small and simple petition system. The petition system is <a href=\"http://en.wikipedia.org/wiki/Free_software\">free software</a> as <a href=\"http://www.gnu.org/philosophy/free-sw.html\">defined</a> by the <a href=\"http://www.fsf.org/\">Free Software Foundation</a> since it is licensed under the GNU Affero General Public License 3 or any later version of this license. The next step of the installation will show you the full text of the license, to which you agree by using the software. A short overview over the permissions you obtain: ".
                               ...
                               "But: ".
                               "<ul>".
                               "  <li>Values in the database are not required to be published with the source code, as long as they're generated by user interaction and are not responsible for the inner workings of the software.</li>".
...
define("LANG_STEP4_DOMAINROOTDESCRIPTION", "Please enter the domain and server path of the petition system you're currently installing. This path will be used to construct absolute links to the petition system on your server.");
